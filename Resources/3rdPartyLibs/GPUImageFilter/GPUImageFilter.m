...
- (UIImage *)imageFromCurrentlyProcessedOutputWithOrientation:(UIImageOrientation)imageOrientation;
{
  ...
  // FIXME: the orientation incorrect, so just create the new image no rotation
  // [UIImage imageWithCGImage:cgImageFromBytes scale:1.0 orientation:imageOrientation]; 
