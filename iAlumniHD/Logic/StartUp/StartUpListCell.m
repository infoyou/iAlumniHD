...
@implementation StartUpListCell
@synthesize url = _url;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _bgBackView = [[[UIImageView alloc] initWithFrame:CGRectMake(MARGIN*2, MARGIN*2, EVENT_CELL_WIDTH, EVENT_LIST_CELL_HEIGHT-2*MARGIN)] autorelease];
...
- (void)drawStartUp:(Event *)event {
    ...
    _signUpCountLabel.text = [NSString stringWithFormat:@"%@: %d%@", LocaleStringForKey(NSEventJoinedTitle, nil), [event.backerCount intValue], LocaleStringForKey(NSEventPersonTitle, nil)];
