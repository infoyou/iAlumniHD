...
@implementation EventDetailActionView
...
- (void)initButtons {
    ...
    WXWGradientButton *awardBtn = [[[WXWGradientButton alloc] initWithFrame:CGRectMake(BUTTON_WIDTH, 0,
                                                                                     BUTTON_WIDTH, BUTTON_HEIGHT)
                                                                   target:self
                                                                   action:@selector(selectionAction:)
                                                                colorType:TRANSPARENT_BTN_COLOR_TY
                                                                    title:LocaleStringForKey(NSAwardTitle, nil)
                                                                    image:[UIImage imageNamed:@"award.png"]
                                                               titleColor:[UIColor whiteColor]
                                                         titleShadowColor:[UIColor clearColor]
                                                                titleFont:FONT(10)
                                                              roundedType:NO_ROUNDED
    ...
    WXWGradientButton *discussBtn = [[[WXWGradientButton alloc] initWithFrame:CGRectMake(BUTTON_WIDTH * 2, 0,
                                                                                       BUTTON_WIDTH,
                                                                                       BUTTON_HEIGHT)
                                                                     target:self
                                                                     action:@selector(selectionAction:)
    ...
    WXWGradientButton *otherBtn = [[[WXWGradientButton alloc] initWithFrame:CGRectMake(BUTTON_WIDTH * 3, 0,
                                                                                     BUTTON_WIDTH,
                                                                                     BUTTON_HEIGHT)
                                                                   target:self
                                                                   action:@selector(selectionAction:)
